...
CREATE TABLE `avatars` (
  `ava_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `ava_name` varchar(45) NOT NULL,
  `ava_img` blob NOT NULL,
  `ava_is_deleted` datetime DEFAULT NULL,
  PRIMARY KEY (`ava_id`),
  UNIQUE KEY `ava_name_UNIQUE` (`ava_name`)
...
-- Dump completed on 2023-12-22 23:50:36
